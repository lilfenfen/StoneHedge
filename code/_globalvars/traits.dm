...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_NOCSNEAK" = TRAIT_NOCSNEAK,
		"TRAIT_MALUMSGRACE" = TRAIT_MALUMSGRACE,
		"TRAIT_BLINDFIGHTING" = TRAIT_BLINDFIGHTING,
		"TRAIT_NIGHT_VISION" = TRAIT_NIGHT_VISION,
		"TRAIT_SUPER_NV" = TRAIT_SUPER_NV,
		...
		"TRAIT_MISSILESNARING" = TRAIT_MISSILESNARING,
