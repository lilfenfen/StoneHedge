// Statpacks focusing on mental-stats - perfect for wizard and religious archetypes.
/datum/statpack/mental/scholarly
	name = "Studious"
	desc = "Your understanding of the world avails you, more often than not."
	stat_array =  list(STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 2)
...
/datum/statpack/mental/precise
	...
	stat_array = list(STAT_PERCEPTION = 2, STAT_STRENGTH = 1)
...
/datum/statpack/mental/industrious
	...
	stat_array =  list(STAT_INTELLIGENCE = 2, STAT_SPEED = 1)
