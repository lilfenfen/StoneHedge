...
/datum/statpack/wildcard/fated
	...
	stat_array = list(STAT_STRENGTH = list(-1, 2), STAT_PERCEPTION = list(-1, 2), STAT_INTELLIGENCE = list(-1, 2), STAT_CONSTITUTION = list(-1, 2), STAT_ENDURANCE = list(-1, 2), STAT_SPEED = list(-1, 2), STAT_FORTUNE = list(-1, 2))
