...
/datum/statpack/physical/trained
	...
	stat_array = list(STAT_STRENGTH = 2, STAT_CONSTITUTION = 2, STAT_INTELLIGENCE = -1)
...
/datum/statpack/physical/muscular
	...
	stat_array = list(STAT_STRENGTH = 2, STAT_CONSTITUTION = 1)
...
/datum/statpack/physical/tactician
	...
	stat_array = list(STAT_STRENGTH = 1, STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 1)
...
/datum/statpack/physical/taut
	...
	stat_array = list(STAT_STRENGTH = 1, STAT_SPEED = 2)
...
/datum/statpack/physical/toil
	...
	stat_array = list(STAT_CONSTITUTION = 2, STAT_ENDURANCE = 2, STAT_STRENGTH = -1)


/datum/statpack/physical/struggler
	name = "Struggler"
	desc = "Lyfe's dealt you a poor hand, so you've opted to simply flip the table instead."
	stat_array = list(STAT_STRENGTH = 1, STAT_CONSTITUTION = 1, STAT_ENDURANCE = 1)
